...
```text
input:
รับค่าคะแนนทั้งหมด และรับค่าคะแนนสูงสุด

output:
หากโอกาสความเป็นไปได้ที่คะแนนสูงสุด และคะแนนต่ำสุดมีค่ามากกว่า 2 คะแนน จะเกิด surprising หากไม่มีโอกาสจะแสดง Not surprising

Constraints:
input เป็นจำนวนจริง ควรพิจารณาโอกาสที่คะแนนสูงสุดมีสองคน
```
...
```text
Step 1:  รับค่าคะแนนรวมและคะแนนสุงสุด
Step 2:  นำคะแนนรวม ลบด้วย คะแนนสูงสุดแล้วหารด้วย 2
Step 3: นำมาเทียบค่าว่าหากเกินสองให้แสดง surprising หากไม่เกิน 2 ให้แสดง Not surprising
```
...
```text
Step 1:  รับค่าคะแนนรวมและคะแนนสุงสุด
Step 2:  หาคะแนนน้อยสุดที่มีโอกาสเป็นไปได้
Step 3: นำมาเทียบค่าว่าหากเกินสองให้แสดง surprising หากไม่เกิน 2 ให้แสดง Not surprising
```
...
```text
ให้คำใบ้เกี่ยวกับเทสเคสที่ยังไม่ผ่าน ให้แนวคิดให้ว่ายังมีกรณีไหนบ้างที่ผมยังคิดไม่ถึง
```
