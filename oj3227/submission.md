...
```text
input:
รับค่าตัวอักษร ที่สามารถ แยกเป็น ตัวเลขไพ่หรือชนิดไพ่ และ สัญลักษณ์ของไพ่

output:
แสดงค่าของไพ่ที่รับมาเป็นฉบับเต็ม

Constraints:
ชื่อย่อที่รับมาเมื่อแปลงเป็นชื่อเต็มจะต้องมีคำว่า of คั่นอยุ่
```
...
```text
step 1: สร้าง key ชนิดไพ่และสัญลักษณ์ไพ่ โดยเนื้อของ key เป็นชื่อเต็ม
step 2: รับค่าข้อความโดยแปลงเป็นตัวใหญ่เพื่อกันการผิดพลาด
step 3: เช็คความยาวของข้อความที่รับมาเพื่อแบ่งตัวหน้าและตัวหลังเพื่อนำไปใช้เป็น Key
step 4: เทียบตัวหน้าว่าเป็นตัวเลขหรือไม่ หากเป็นจะแสดงตัวเลข "of" และตัวด้านหลังที่เข้าด้วย key แล้ว แต่หากไ่ม่แสดงว่าตัวด้านหน้าจะเป็นชนิดของไพ่ที่เป็นชื่อเต็ม "of" และตามด้วยตัวด้านหลังที่เข้าด้วย key แล้ว
```
...
```text
วิธีสุดท้ายของผมเหมือนวิธีแรกเลยครับโดยรับค่ามาแปลงเป็นตัวพิมพ์ใหญ่ เช็คความยาวของข้อความ เช็คตัวด้านนห้าว่าเป็นเลขไหม แล้วแสดงผล
```
