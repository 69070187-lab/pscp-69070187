...
```text
Input:
รับความยาวตัวอักษรภาษาอังกฤษ
Output:
แสดงผล string ที่รับเข้ามาแบบกลับด้านและตัวเล็ก
Constraints:
การบังคับให้ Output เป็นตัวเล็กเท่านั้น
```
...
```text
Step 1: รับค่าตัวอักษรภาษาอังกฤษ
Step 2: กลับด้านค่าตัวอักษรที่รับมา โดยใช้ String Sling
Step 3: ปรับให้ตัวอักษรเป็นแบบพิมพ์เล็กทั้งหมด โดยใช้ .lower()
Step 4: แสดงผลค่าหลังจากการแปลงตัวอักษรแล้ว
```
...
```text
วิธีสุดท้ายเหมือนกับแผนแรก เพราะสามารถรันเทสเคสผ่าน ทั้ง 6 เทสเคส โดยสามารถกลับด้านตัวอักษรและให้ตัวอักษรเป็นตัวเล็กทั้งหมดได้
```
...
```text
เช็คบังคับการแปลงตัวอักษร ให้เป็นพิมพ์เล็กทั้งหมด
```
