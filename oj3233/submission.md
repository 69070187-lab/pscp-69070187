...
```text
input: 
รับค่าของ id และ เลข ของลอตเตอรี่ ที่ออกรางวัล
รับค่าของ id และ เลข ของลอตเตอรี่ ที่ซื้อ

output:
แสดงค่าเงินรางวัลที่จะได้หากถูกลอตเตอรี่

constraints:
จะถูกเพียงรางวัลเดียว
```
...
```text
step 1: รับค่าของ id และเลขของลอตเตอรี่ ออกผล และที่ซื้อ
step 2: เทียบค่า หาก id หากตรงกัน ให้ไปเทียบเลขต่อ โดยเทียบ 3 ตัวท้ายและ 2 ตัวท้าย
โดยจะเก็บจำนวนเก็บที่ถูกรางวัลไว้
step 3: เทียบค่า หาก id หากไม่ตรงกัน ให้ไปเทียบเลขต่อ โดยเทียบ 3 ตัวท้ายและ 2 ตัวท้าย โดยจะเก็บจำนวนเก็บที่ถูกรางวัลไว้ โดยจำนวนเงินรางวัลของกรณีที่ id ไม่ตรงกันจะน้อยกว่า
step 4: แสดงจำนวนเงินรางวัล
```
...
```text
วิธีสุดท้ายของผมเหมือนวิธีแรกคือรับค่าลอตเตอรี่ หลังจากนั้นเทียบ id และตัวเลขเพื่อเก็บจำนวนเงินรางวัล หลังจากนั้นจะแสดงเงินรางวัลที่ได้ัรับ
```
...
```text
ID เหมือน + 3456 เหมือนกัน ([2:])
ตัวอักษรเหมือน เลขเหมือน
```
