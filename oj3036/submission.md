...
output:
จำนวนที่พังกำแพงน้อยที่สุด


Constraints:
N เป็นจำนวนเต็ม และ 1 <= N <= 100,000
```
...
```text
Step 1: อ่านค่า n จาก input
Step 2: หาว่า n อยู่ในชั้นที่เท่าไร โดยใช้ math.isqrt(n - 1) + 1
Step 3: หาเลขตำแหน่งของห้อง n ในชั้นนั้น เก็บไว้ใน p
Step 4: ดูว่า p เป็นเลขคู่หรือเลขคี่ เพื่อเลือกจำนวนกำแพงที่ต้องพัง
Step 5: ถ้า p เป็นเลขคู่ ให้ตอบ 2 * r - 3 ถ้า p เป็นเลขคี่ ให้ตอบ 2 * r - 2
```
...
```text
วิธีสุดท้ายของผมยังใช้แนวคิดเดิม คือหาว่าห้อง n อยู่ชั้นไหนก่อน แล้วหาตำแหน่งของห้องในชั้นนั้น จากนั้นใช้ว่า p เป็นเลขคู่หรือเลขคี่เพื่อเลือกจำนวนกำแพงที่น้อยที่สุด 
```
...
```text
ห้องที่อยู่ชั้นถัดจากห้อง 1 เป็นกรณีง่ายที่สุดที่ต้องเดิน 1 ครั้ง
```
...
```text
ใช้ตรวจอีกฝั่งของห้อง 1 ว่าได้ผลเหมือนห้อง 2
```
