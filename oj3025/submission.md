...
```text
input :
รับค่าของเดือน และวัน (integer)
output :
แสดงผล ฤดูกาล (string) โดยการเปลี่ยนฤดูกาลจะเปลี่ยนไปทุกๆ 3 เดือน และหลังจากวันที่ 21 เป็นต้นไป
constraints :
ควรพิจารณา กรณีที่ หลังจากวันที่ 21 อาจจะเข้าข่าย การเปลี่ยนฤดู และกรณีที่ เดือนเกิน 12 เดือน
```
...
```text
step 1: รับค่าจำนวนเต็มไว้ในตัวแปร month
step 2: รับค่าจำนวนเต็มไว้ในตัวแปร day
step 3: ตรวจเช็คว่าวันที่รับมามากกว่าหรือเท่ากับ 21 วันไหม หากเกินให้ทำการ +1 ที่ตัวแปร month
step 4: ตรวจเช็คว่าตัวแปร month มีค่ามากกว่า 12 หรือไม่ หากเกินให้ทำการหารเอาเศษ ด้วย 12
step 5: ตรวจเช้คว่าหากตัวแปร month เท่ากับ  1,2,3 ให้แสดงผลเป็น winter หากตัวแปร month เท่ากับ 4,5,6 ให้แสดงผลเป็น spring หากตัวแปร month เท่ากับ 7,8,9 ให้แสดงผลเป็น summer หากตัวแปร month เท่ากับ 10,11,12 ให้แสดงผลเป็น fall
```
...
```text
วิธีสุดท้ายของผลเหมือนกับวิธีแรก 
```
...
```text
ตรวจสอบหากเดือนและวันที่เป็น 0
```
