...
```text
input:
รับค่าอุณหภูมิ เป็นจำนวนจริง
รับค่าหน่วยของอุณหภูมิที่รับมา
รับค่าหน่วยของอุณหภูมิที่ต้องการแปลงหน่วย

output:
แสดงผลค่าอุณหภูมิที่ทำการแปลงแล้วได้อย่างถูกต้อง

Constraints:
การรับค่าเข้ามาเป็นจำนวนจริง และการแสดงผลแบบทศนิยมสองตำแหน่ง
```
...
```text
Step 1: รับค่าอุณหภูมิ เป็นจำนวนจริง
Step 2: รับค่าหน่วยของอุณหภูมิที่รับมา
Step 3: รับค่าหน่วยของอุณหภูมิที่ต้องการแปลง
Step 4: ทำการแปลงหน่วย เป็นอุณหภูมิในหน่วยที่ต้องการแปลง
Step 5: แสดงผลค่าอุณหภูมิ หลังจากการแปลงเสร็จ โดยเป็นทศนิยม  2 ตำแหน่ง
```
...
```text
วิธีสุดท้ายของผมไม่เหมือนวิธีแรก
Step 1: รับค่าอุณหภูมิ เป็นจำนวนจริง
Step 2: รับค่าหน่วยของอุณหภูมิที่รับมา
Step 3: รับค่าหน่วยของอุณหภูมิที่ต้องการแปลง
Step 4: แปลงค่าอุณหภูมิที่รับมาเป็น หน่วย C ก่อน (Step ที่เพิ่มมา)
Step 5: ทำการแปลงหน่วย เป็นอุณหภูมิในหน่วยที่ต้องการแปลง
Step 6: แสดงผลค่าอุณหภูมิ หลังจากการแปลงเสร็จ โดยเป็นทศนิยม  2 ตำแหน่ง

หลังจากการเพิ่มใน Step ที่ 4 เข้ามาทำให้โปรแกรมของผมมีความยาวโค้ดที่สั้นลง และทำให้สามารถหาตำแหน่งผิดพลาดได้ง่ายขึ้นครับ
```
...
```text
ตรวจสอบสมการของ อุณหภูมิหน่วย C และ K
```
...
```text
ตรวจสอบสมการของ อุณหภูมิหน่วย F และ R
```
