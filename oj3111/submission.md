...
Constraints:
ส่วนลดตอนเป็นสมาชิกคือ 5% ส่วนลดตอนไม่เป็นสมาชิกแต่ซือมากกว่า 499 คือ 3%
```
...
```text
Step 1: อ่านสถานะสมาชิกสหกรณ์ "Y" หรือ "N"
Step 2: อ่านจำนวนรายการสินค้า n
Step 3: อ่านราคาสินค้าทั้งหมด n รายการ และหาผลรวม
Step 4: ถ้าสถานะเป็น "Y" ให้ลดราคาสินค้ารวม 5%
Step 5: ถ้าสถานะเป็น "N" และราคาสินค้ารวมตั้งแต่ 500 บาทขึ้นไป ให้ลดราคา 3%
Step 6: ปัดราคาสุดท้ายให้เหลือทศนิยม 2 ตำแหน่ง
Step 7: พิมพ์ราคาสุทธิในรูปแบบทศนิยม 2 ตำแหน่ง
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก ฉันใช้ modulo เพื่อตรวจสอบเศษจากการหาร n ด้วย 2 ถ้าเศษเป็น 0 แสดงว่าเป็นเลขคู่ มิฉะนั้นจะเป็นเลขคี่ หลังจากเพื่อนแนะนำให้คำนึงถึง edge cases ฉันจึงทดสอบเพิ่มเติมด้วย 0 และตัวเลขติดลบด้วยตนเอง
```
