...
รับค่าสี สอง ค่า
Output:
แสดงสีที่ผสม หากสีที่รับเข้ามาเป็นอย่างอื่นนอกจาก แดง เหลือง ฟ้า ให้แสดง Error
Constraints:
ควรพิจารณากรณีที่เป็นสีเดียวกันด้วย
...
```text
Step 1: รับค่าสี สองค่า
Step 2: เช็คว่าหากผสมสีแดงกับสีเหลือง ให้แสดงผลสีส้ม
Step 3: เช็คว่าหากผสมสีแดงกับสีฟ้า ให้แสดงผลสีม่วง
Step 4: เช็คว่าหากผสมสีเหลืองกับสีฟ้า ให้แสดงผลสีเขียว
Step 5: หากเป็นกรณีอื่นๆให้แสดง Error
```
...
```text
วิธีสุดท้ายต่างจากวิธีแรกคือการเพิ่มกรณีที่การรับสีเข้ามาเป็นสีเดียวกัน
```
...
```text
ตรวจตัวอักษรการรับเข้ามาว่าต้องตรงทุกตัวอักษร
```
...
```text
ตรวจในกรณีที่สีที่รับมามีค่าเหมือนกัน
```
...
```text
ช่วยให้คำใบ้ว่าหากเเป็นกรณีที่สีเป็นสีเดียวกันโปรแกรมที่เขียนจะมีค่าออกมายังไง
```

คุณยังทำอะไรด้วยตนเอง

```text
แก้โปรแกรมเพิ่มกรณีการเช็คเมื่อค่าสีที่รับมามีค่าเหมือนกัน
```
