...
output: 
แสดงค่าน้ำหนักพัสดุ เป็นทศนิยม 2 ตำแหน่ง

Constraints:
input ต้องเป้นตัวพิมพ์ใหญ่เท่านั้น ต้องเป็นต้นทางกับปลายทางที่กำหนดให้เท่านั้น
```
...
step 2: เทียบต้นทางกับปลายทาง หากไม่มีตามที่กำหนดให้แสดง ERROR
step 3: นำค่าธรรมเนียมธรรมดา + (ค่าธรรมเนียมน้ำหนัก * นำหนัก)  แล้วแสดงผลราคาที่ต้องจ่าย
```
...
```text
วิธีสุดท้ายของผมเหมือนกับวิธีแรกเลยครับ คือการนำไปเทียบ ต้นทางปลายทางแล้วจึงค่อยคำนวณค่าที่ต้องจ่าย
```
