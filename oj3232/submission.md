...
```text
input:
รับค่าการกระโดดครั้งแรก
รับค่าเป้าหมายที่อยากกระโดดไป

output:
จำนวนการกระโดดขั้นต่ำที่ทำให้ถึงระยะที่ต้องการ หากกระโดดไม่ถึงจะแสดง -1

constraints: ขั้นต่ำของการกระโดด สูงสุด 1000 และเป้าหมายที่จะกระโดด สูงสุด 100,000
...
```text
step 1: รับค่าของระยะทางที่สามารถกระโดดได้ในครั้งแรก และระยะทางที่อยากกระโดดไปให้ถึง
step 2: ลูปหา จำนวนครั้งในการกระโดด 
step 3: ถ้าระยะทางรวมที่กระโดดได้มากกว่าหรือเท่ากับระยะที่อยากกระโดดไปถึง จะแสดงจำนวนขั้นต่ำในการกระโดดและออกจากฟังก์ชั่น หากไม่จะลดระยะทางในการกระโดด
step 4: หากไม่เข้ารูปจะแสดง -1
```
...
```text
วิธีสุดท้ายของผมเหมือนกับวิธีแรก คือรับค่าเข้ามา ลูปหาระยะทางที่กระโดด นับจำนวนการกระโดด นำระยะทางที่กระโดดไปเปรียบเทียบ และแสดงจำนวนการกระโดดที่น้อยที่สุด
```
...
```text
ครั้งที่ 3 ได้ 24 ยังไม่ถึง ต้องครั้งที่ 4
```
...
```text
กระโดดครั้งแรกก็เกินเป้าหมายแล้ว
```
