...
```text
Input:
รับจำนวนเงินที่ต้องจ่ายค่าเครื่องดื่ม และอาหาร

Output:
แสดงค่าจำนวนเงินที่ต้องจ่ายหลังจากการคำนวณบวกค่า บริการและค่า VAT แล้ว

Constraints:
ควรพิจารณากรณีเมื่อค่าบริการ น้อยกว่า 50 หรือมากกว่า 1000 โดยร้านนี้จะคิดค่าบริการเริ่มต้น 50 และไม่เกิน 1000
```
...
```text
Step 1: รับจำนวนเงินค่าอาหารและเครื่องดื่มรวใกัน เป็นจำนวนเต็ม
Step 2: คิดค่าบริการ โดยคิดจากการนำค่าอาหารและเครื่องดื่มรวมกัน คูณกับ 0.1 (เท่ากับ 10 %)
Step 3: เช็คว่าค่าบริการน้อยกว่า 50 หรือมากกว่า 1000 หรือไม่ หากน้อยกว่า 50 จะคิดค่าบริการเป็น 50 บาท หากมากกว่า 1000 จะคิดค่าบริการเป็น 1000 บาท
Step 4: คิดค่า VAT โดยการนำค่าบริการ รวมกับ ค่าอาหารและเครื่องดื่ม และนำไปคูณกับ 0.07 (เท่ากับ 7%)
Step 5: คำนวณเงินทั้งหมดที่ต้องจ่ายโดยการนำ ค่าอาหารและเครื่องดื่ม รวมกับ ค่าบริการและค่า VAT
Step 6: แสดงผลจำนวนเงินทั้งหมดที่ต้องจ่ายโดยเป็นทศนิยม 2 ตำแหน่ง
```
...
```text
วิธีสุดท้ายเหมือนกับแผนแรกเพราะ มีการคิดค่าบริการ ค่า Vat ที่ถูกต้อง และยังมีการคำนวณเงินทั้งหมดที่ต้องจ่ายเป็นทศนิยม 2 ตำแหน่งถูกต้องตาม simple testcase
```
