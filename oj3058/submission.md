...
```text
input:
1. จำนวนของอิฐก้อนเล็ก
2. จำนวนของอิฐก้อนใหญ่
3. ความยาวสะพาน

output:
จำนวอิฐก้อนเล็กที่ต้องใช้ ถ้าสร้างไม่ได้ให้แสดง -1
...
```text
step 1: รับจำนวนอิบก้อนเล็ก ก้อนใหญ่และความยาวสะพานที่ต้องการ
step 2: เทียบหาจำนวนอิฐก้อนใหญ่ที่ต้องใช้
step 3: หาจำนวนอิฐก้อนเล็กที่ต้องใช้
step 4: หากสามารถหาค่าที่ได้น้อยกว่าหรือเท่ากับอิฐก้อนเล็กให้แสดงผลจำนวนอิฐที่ต้องใช้ หากไม่แสดง -1
```
...
```text
วิธีสุดท้ายของผลเหมือนกับวิธีแรกเลยครับ ตรวจสอบจำนวนอิฐก้อนใหญ่ที่ต้องใช้ก่อนจึงไปเทียบหาอิฐก้อนเลกที่ต้องใช้ หลังจากนั้นจึงแสดงค่าตามเงื่อนไขครับ
```
...
```text
มี big มากกว่าเป้าหมายที่ใช้ได้
```
