...
```text
input: 
รับค่าของช่วงที่ต้องการหาจำนวนเฉพาะ

output: 
เลขที่เป็นจำนวนเฉพาะ และจำนวนของเลขจำนวนเฉพาะ

Constraints:
จำนวนเฉพาะจะมากกว่า 1
```
...
```text
step 1 รับค่าช่วงที่ต้องการหาจำนวเฉพาะ
step 2 ลูปหาจำนวนเฉพาะ โดยการให้ ถ้า i % j แล้วไม่เหลือเศษ ให้บวกจำนวน count
step 3 เช็ค count เท่ากับสองหรือไม่ เผื่อเช็คว่าเป็นจำนวนเฉพาะหรือไม่ หากเท่ากับสอง ให้เพิ่มจำนวนนั้นลงในลิสของจำนวนที่เป้นจำนวนเฉพาะ
step 4 แสดงเลขจำนวนเฉพาะ และจำนวนที่เป็นจำนวนเฉพาะ
```
...
```text
วิธีสุดท้ายของผมแตกต่างกันตรงที่ิธีสุดท้ายของผมจะเช็คว่าช่วงเริ่มต้องมากกว่าหรือเท่ากับช่วงสุดท้าย เพิ่มเข้ามาอีกด้วยครับ
```
...
```text
Boundary Case ช่วงมีแค่เลขเดียว และเลขนั้นเป็นจำนวนเฉพาะ
```
...
```text
ทดสอบค่าที่น้อยกว่า 2 ซึ่งโค้ดต้องข้ามด้วย continue
```
...
```text
ทดสอบช่วงที่ไม่มีเลข 0, 1 และมีจำนวนเฉพาะหลายตัว
```
