...
```text
input:
รับค่าจำนวนคน จำนวนการเปลี่ยนพิจารณาของ และตำแหน่งของโจร

output:
แสดงค่าจำนวนคนที่ได้พิจารณาของขวัญ
```
...
```text
step 1: รับค่าจำนวนคน จำนวนการเปลี่ยนพิจารณาของ และตำแหน่งของโจร
step 2: ลูปโดยหากตำแหน่ง เท่ากับตำแหน่งของโจรให้บวกจำนวนพิจารณา และหยุดลูป ต่อมาหากตำแหน่งเท่ากับคนที่หนึ่งให้หยุดการลูป หากไม่ให้เพิ่มจำนวนพิจารณา และเพิ่มจำนวนตำแหน่ง add ตำแหน่ง โดยหากจำนวนตำแหน่งมากกว่าคนที่เล่นให้ปรับตำแหน่งให้อยู่ในขอบเขตของคนที่เล่น
step 3: แสดงจำนวนคนที่พิจารณา
```
...
```text
วิธีสุดท้ายของผมแตกต่างกับวิธีแรก ที่ผมจะต้องพิจารณา หากโจรคือคนที่ 1 ให้แสดงจำนวนคนที่พิจารณาคือ 1 หากไม่ใช่ให้เพิ่มตำแหน่ง add คน และจำนวนพิจารณาเป็น 1
```
...
```text
กรณีพื้นฐาน เดินทีละ 1: 1 → 2 → 3 และเจอขโมย
```
...
```text
ทดสอบกรณี bandit == 1 ซึ่งเป็นเงื่อนไขพิเศษของโปรแกรม
```
...
```text
ทดสอบการเดินที่ต้อง วนกลับเมื่อเกินจำนวนคน
```
