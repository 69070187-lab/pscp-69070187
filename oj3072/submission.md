...
step 2: เช็คแต่ละตัวว่าเป้นสระไหม โดยใช้ count เช็คจำนวนข้อความที่กำหนดให้
step 3: แสดงจำนวนของแต่ละสระ
```
...
```text
วิธีสุดท้ายของผมเหมือนกับวิธีแรกเลย ใช้ .count ในการตรวจสอบจำนวนสระที่กำหนดให้ในข้อความ
```
