...
```text
input:
รับจำนวนคำสั่งที่ต้องการป้อนและคำสั่งที่ต้องการ
...
```text
step 1: รับค่าจำนวนคำสั่งที่ต้องการป้อน
step 2: ลูปรับค่าคำสั่งที่ต้องการใช้
step 3: ถ้าคำสั่งเป็น "+" ให้บวกสิบ แต่หากคำสั่งเป็น "-" ให้ลบด้วย 5
step 4: แสดงค่าที่คำนวณแล้ว
```
...
```text
วิธีสุดท้ายของผมเหมือนกับวิธีแรกเลยครับ โดยการรับจำนวนลูปของคำสั่ง และลูปรับคำสั่ง โดยพิจารณาคำสั่งที่รับมานำไปคำนวณเลข หลังจากนั้นแสดงเลขที่คำนวณแล้ว
```
...
```text
ทดสอบกรณีพื้นฐานที่สุดว่า + เพิ่มคะแนน 10 ได้ถูกต้อง
```
...
```text
ทดสอบคำสั่ง + ซ้ำหลายครั้ง และตรวจสอบว่า loop ทำงานครบทุกครั้ง
```
...
```text
ทดสอบการสลับคำสั่ง เพื่อดูว่าการเพิ่ม/ลดคะแนนไม่ส่งผลผิดลำดับ
```
