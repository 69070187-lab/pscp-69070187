...
```text
input:
1. รับค่าของจำนวนนับ A และ B
2. รับค่าตัวหาร
3. รับค่าเศษ

output:
แสดงจำนวนข้อมูลที่ หารด้วยตัวหารแล้วเหลือเศษตามที่กำหนด

Constraints:
B>A และ ตัวหารต้องมากกว่าตัวเศษ
```
...
```text
step 1: รับค่าประเภท ปริมาณไข่มุก หน่วยกรัม
step 2: รับค่าชนิดของชา ระดับความหวาน ปริมาตร
step 3: นำค่า ประเภท ปริมาณไข่มุก เข้าฟังก์ชั่น mock เพื่อคำนวณปริมาณพลังงาน
step 4: นำค่า ชนิดของชา ระดับความหวาน ปริมาตร เข้าฟังก์ชั่น tea เพื่อคำนวณปริมาณพลังงาน
step 5: นำค่าจากฟังก์ชั่น mock + tea
step 6: แสดงผลแบบเลือกทศนิยม
```
...
```text
เหมือนกับวิธีแรกเลยครับเพราะสามารถหาปริมาณของพลังงานได้อย่างถูกต้่องครับ
```
