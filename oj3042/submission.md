...
output:
แสดงค่าที่หาร 10 ลงตัวโดยเรียงจากมากไปน้อย

constrains:
การแสดง output โดยมีช่องว่างคั่นระหว่างกลางตัวเลข
```
...
```text
Step 1: รับค่าจำนวนเต็ม 1 ค่า
Step 2: เข้าโปแกรมลูป โดยเช็คว่าหาก i % 10 == 0 ให้เพิ่มค่าลงใน result
Step 3: เรียงค่าใน List จากมากไปน้อย
Step 4: แปลงทุกตัวใน list เป็น string
Step 5: แปลง list เป็น str โดยมีช่องว่างคั่นกลาง
```
...
```text
วิธีสุดท้ายของผมเหมือนกับแผนแรก เพราะ modulo นี้สามารถแสดงผลเลขที่สามารถหาร 10 ลงตัวโดยนับตั้งแต่ เลข 0 ไปจนถึงเลขที่รับมา
```
...
```text
ตรวจสอบเมื่อเลขตรงกับตัวสุดท้ายที่ 10 หารลงตัวพอดี
```
